      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        ...
        <div className="border-t border-white/20 pt-10 grid grid-cols-2 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3 mb-8">
              <a
                href="#"
                className="border border-white/40 rounded-lg px-4 py-2 flex items-center gap-3 hover:border-white transition-colors"
              >
                <svg
                  className="w-5 h-5"
                  viewBox="0 0 24 24"
        ...
        <div className="border-t border-white/20 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <span className="inline-flex items-center gap-2 text-sm text-white/50">
            <span>2026 Ta'am Beit. All rights reserved.</span>
          </span>
        </div>
      </div>
    </footer>
