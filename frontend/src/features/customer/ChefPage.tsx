      ...
      <div className="p-3">
        ...
        {meal.variants[0] && (
          <p className="text-sm font-bold text-[--text-primary] mt-1">
            {meal.variants.find((v) => v.isDefault)?.price ??
...
export default function ChefPage() {
  ...
  const heroImg =
    HERO_IMGS[parseInt(id?.slice(-1) ?? "0", 16) % HERO_IMGS.length];
            ...
            <div className="absolute top-4 right-4 flex gap-2">
              ...
              >
                <Heart
                  size={18}
                  className={
                    liked ? "fill-red-500 text-red-500" : "text-[--text-muted]"
                  }
                />
              </button>
            </div>
              ...
              {chefCard && (
                <>
                  <StatBadge
                    ...
                    value={
                      chefCard.rating > 0 ? chefCard.rating.toFixed(1) : "—"
                    }
                    label="Rating"
                  />
                  <StatBadge
