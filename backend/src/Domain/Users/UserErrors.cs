...
public static class UserErrors
{
    ...
    public static readonly Error DeliveryManCurrentlyDeliveringAnotherOrder = Error.Problem(
        "Users.DeliveryManCurrentlyDeliveringAnotherOrder",
        "This delivery man is already delivering another order.");
