...
import GeoGuard from '@/components/ui/GeoGuard'
...
function MenuPageInner() {
  ...
  // ── Read location from global geo store ────────────────────────────────────
  const { location } = useGeoStore()
  // GeoGuard above us guarantees location is non-null and fresh
...
// ── Wrapper: ensures a fresh geo location before rendering ───────────────────
