...
const MOCK_REVIEWS = [
  {
    ...
    rating: 4.5,
    date: "1/3/2024",
    text: "Great Dessert with variety of toppings!",
  },
  {
    id: "2",
    ...
    rating: 4.5,
    date: "1/3/2024",
    text: "It was delicious, I recommend to get it with...",
  },
  {
    id: "3",
    author: "Ahmed Ibrahim",
          ...
          return (
            ...
            >
              ...
              <input
                ...
                className="sr-only"
                checked={isSelected}
                onChange={() => onToggle(s.sideDishId)}
              />
...
export default function MealDetailPage() {
  ...
  useEffect(() => {
    if (meal) {
      const required = meal.sideDishes
    ...
    setSelectedToppings((prev) => {
      ...
      if (next.has(optionId)) {
        ...
        if (maxSelections === 1) {
          ...
          const group = meal?.toppingGroups.find(
  ...
  const activeVariant = meal?.variants.find(
