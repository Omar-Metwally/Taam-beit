...
public interface IOrderNotificationService
{
    ...
    /// Sends the full order payload (fat notification) — the frontend renders directly
    /// from this push without a follow-up API call, eliminating the thundering herd
    /// problem that would occur if 20 drivers all fetched simultaneously.
    ...
    /// </summary>
    Task NotifyNearbyDeliveryMenAsync(
